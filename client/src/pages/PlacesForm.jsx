            ...
            <div>
                <form onSubmit={savePlace}>
                    ...
                    <Perks selected={perks}
                        onChange={setPerks} />
                    {preInput('Extra Info', 'add information of your place')}
                    <textarea
                        value={extraInfo}
                        onChange={ev => setExtraInfo(ev.target.value)}></textarea>
                    {preInput('Check IN & Out time and Max. number of guests', 'add check IN time, check OUT time &#40; remember to have some time window for cleaning the room before next check in &#41; and Maximun number of guests')}
                    ...
                    <div>
                        <button className="login mt-4">Save</button>
                    </div>
