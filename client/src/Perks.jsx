export default function Perks({ selected, onChange }) {
    ...
    return (
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2 mt-2">
            <label className="border p-4 flex items-center justify-start gap-2">
                <input type="checkbox" checked={selected.includes('wifi')} name="wifi" onChange={handleCheckboxChange} />
            ...
            <label className="border p-4 flex items-center justify-start gap-2">
                <input type="checkbox" checked={selected.includes('parking')} name="parking" onChange={handleCheckboxChange} />
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6">
            ...
            <label className="border p-4 flex items-center justify-start gap-2">
                <input type="checkbox" checked={selected.includes('tv')} name="tv" onChange={handleCheckboxChange} />
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6">
            ...
            <label className="border p-4 flex items-center justify-start gap-2">
                <input type="checkbox" checked={selected.includes('laundry')} name="laundry" onChange={handleCheckboxChange} />
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6">
            ...
            <label className="border p-4 flex items-center justify-start gap-2">
                <input type="checkbox" checked={selected.includes('kitchen')} name="kitchen" onChange={handleCheckboxChange} />
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6">
            ...
            <label className="border p-4 flex items-center justify-start gap-2">
                <input type="checkbox" checked={selected.includes('entrance')} name="entrance" onChange={handleCheckboxChange} />
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6">
